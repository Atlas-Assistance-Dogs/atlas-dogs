trigger ContactTrigger on Contact(
  ...
  if (!Trigger.isInsert) {
    ...
    npe4__Relationship__c[] relationships = [SELECT npe4__Contact__r.Positions__c, 
                                             ...
                                             WHERE (npe4__Type__c LIKE '%Emergency Contact' OR npe4__Type__c = 'Guardian') AND npe4__Status__c = 'Current' AND npe4__RelatedContact__c IN:modifiedContacts.keySet()];
